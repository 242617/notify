...
var file_notify_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x22, 0x29, 0x0a, 0x0d, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79,
	...
	0x6e, 0x73, 0x65, 0x32, 0x43, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x39, 0x0a,
	0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x15, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16,
	0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x65,
...
var file_notify_proto_goTypes = []interface{}{
	(*NotifyRequest)(nil),  // 0: engine.NotifyRequest
	(*NotifyResponse)(nil), // 1: engine.NotifyResponse
}
var file_notify_proto_depIdxs = []int32{
	0, // 0: engine.Notify.Notify:input_type -> engine.NotifyRequest
	1, // 1: engine.Notify.Notify:output_type -> engine.NotifyResponse
...
func (c *notifyClient) Notify(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.Notify/Notify", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedNotifyServer) Notify(context.Context, *NotifyRequest) (*NotifyResponse, error) {
...
func _Notify_Notify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.Notify/Notify",
	}
